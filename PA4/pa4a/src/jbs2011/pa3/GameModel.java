...
public class GameModel  {
	 ...
	 */
	public float gameLength=20; // seconds
	/**
	...
	public void createLevel(int level, int width, int height){
		...
		case 2: // this is a fun level with up to 20 visible blocks, 4 targets and 2 disks..
			for (int i=0;i<10; i++){
				this.addSquare((float)Math.random()*width,(float)Math.random()*(height-100)+100,(float)Math.random()*20+10);
			}
		...
		case 3: // this is a fun level with up to 30 visible blocks, 5 targets and 3 disks..
			for (int i=0;i<10; i++){
